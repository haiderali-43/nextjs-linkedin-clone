...
const Menubar = React.forwardRef(
  ({ className, withoutBorder, ...props }, ref) => (
    <MenubarPrimitive.Root
      ref={ref}
      className={cn(
        `flex h-9 items-center space-x-1 rounded-md  p-1  dark:border-gray-800 dark:bg-gray-950`,
        className
      )}
      {...props}
    />
...
const MenubarTrigger = React.forwardRef(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex select-none items-center rounded-md px-3 py-1 text-sm font-medium outline-none focus:bg-gray-100 focus:text-gray-900 cursor-pointer data-[state=open]:text-gray-900 dark:focus:bg-gray-800 dark:focus:text-gray-50 dark:data-[state=open]:bg-gray-800 dark:data-[state=open]:text-gray-50",
      className
    )}
    {...props}
  />
